...
const values = [
  {
    icon: BookOpen,
    title: 'Tamamen Ücretsiz Eğitim',
    desc: 'Tüm içeriklerimiz reklam dışı kayıt veya ödeme istemeden, ücretsiz olarak sunulur. Hiçbir aileyi geride bırakmamayı taahhüt ediyoruz.',
  },
  {
    icon: Users,
    title: 'Çocuğa Özel Tasarım',
    desc: '4-12 yaş aralığındaki çocuklar için gelişim psikolojisi ve dil edinim araştırmaları temel alınarak hazırlanmış güvenli içerik.',
  },
  {
    icon: Heart,
    title: 'Oyunla Öğrenme',
    desc: 'Çocukların doğal merakını besleyen interaktif sunumlar, görsel anlatım, ezgili şarkılar ve uygulamalı çalışma kâğıtları.',
  },
  {
    icon: Target,
    title: 'CEFR A1 Hizalı Müfredat',
    desc: 'Avrupa Ortak Dil Çerçevesi (CEFR) A1 seviyesi ile uyumlu kelime ve dilbilgisi yapıları. Türkiye Maarif Modeli ile paralel.',
  },
  {
    icon: ShieldCheck,
    title: 'COPPA & KVKK Uyumlu',
    desc: 'Çocuk gizliliği için Children\'s Online Privacy Protection Act ve KVKK standartlarına uygun. Kişisel veri toplamayız.',
  },
  {
    icon: Award,
    title: 'Öğretmen Onaylı',
    desc: 'Aktif sınıf öğretmenleri tarafından gözden geçirilen, çocukla denenmiş, etkililiği gözlemlenmiş eğitim içeriği.',
  },
]
...
export default function About() {
  ...
  useMeta({
    title: 'Hakkımızda — minesminis | Çocuklar İçin İngilizce Öğrenme Platformu',
    description: 'minesminis nedir, neden kurulduk, hangi pedagojik yaklaşımı benimsiyoruz? Çocuklara İngilizce öğretiminde 5 yıllık deneyim, CEFR A1 hizalı içerik, COPPA uyumlu güvenli platform.',
  ...
  return (
    <div style={{ maxWidth: 760, margin: '0 auto' }}>
      ...
      <p className="mm-page-sub" style={{ marginBottom: 24 }}>
        Çocuklara İngilizce öğretmek için, çocuk gibi düşünerek tasarlandı.
      </p>
      ...
      <article style={{ background: 'white', borderRadius: 28, padding: 28, border: '1px solid var(--line)', lineHeight: 1.8, fontSize: 15, color: 'var(--ink-2)', marginBottom: 20 }}>
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 22, color: 'var(--ink)', marginTop: 0 }}>Bir cümlede minesminis</h2>
        <p>
        ...
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 22, color: 'var(--ink)' }}>Misyonumuz</h2>
        <p>
        ...
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 22, color: 'var(--ink)' }}>Pedagojik Yaklaşımımız</h2>
        <p>
          minesminis'in eğitim tasarımı üç ilke üzerine kurulu:
        </p>
        <p>
        ...
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 22, color: 'var(--ink)' }}>İçerik Kapsamımız</h2>
        <p>
          Şu anda platformumuzda CEFR A1 seviyesi ve Türkiye Maarif Modeli 2-4. sınıf İngilizce müfredatı ile hizalı konularda kaynaklar bulunmaktadır:
        </p>
        <ul>
        ...
        <p>
          İçerik kütüphanesi, sahadan gelen öğretmen geri bildirimleri ve aile talepleri doğrultusunda her ay güncellenmektedir. Her yeni başlık, çocukla pilot test yapıldıktan sonra yayınlanır.
        </p>

        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 22, color: 'var(--ink)' }}>Çocuk Güvenliği</h2>
        <p>
          Platformumuz çocuk güvenliğini birinci öncelik olarak kabul eder. Bu yaklaşımı somut güvenlik kararlarına çeviriyoruz:
        </p>
        <ul>
        ...
        <p>
          Daha ayrıntılı bilgi için <Link to="/privacy" style={{ color: 'var(--accent)' }}>Gizlilik Politikası</Link> sayfamızı inceleyebilirsiniz.
        </p>

        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 22, color: 'var(--ink)' }}>Kim Hazırlıyor?</h2>
        <p>
        ...
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 22, color: 'var(--ink)' }}>Vizyonumuz</h2>
        <p>
          minesminis'in uzun vadeli vizyonu, Türk çocuklarının yabancı dil edinim deneyimini "korkulan ders"ten "günün en sevdiği etkinliği"ne dönüştürmektir. Bunu başardığımızda — ki bu pek çok ailede çoktan yaşandı — çocuklar İngilizce'yi sınav değil pencere olarak görmeye başlar. Hedefimiz, önümüzdeki üç yıl içinde 500.000 Türk çocuğa, en az 10 farklı temada nitelikli İngilizce kaynak ulaştırmak.
        </p>
      </article>

      {/* Stats */}
      {(counts.slides + counts.videos + counts.songs + counts.worksheets) > 0 && (
      ...
      <div style={{ marginTop: 28, padding: 24, borderRadius: 20, background: 'linear-gradient(135deg, #F3F0FF 0%, #E8EDFF 100%)', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 8, justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <Link to="/blog" className="mm-btn" style={{ textDecoration: 'none' }}>Blog Yazıları</Link>
        </div>
      </div>
    </div>
  )

  ...
  const save = async (publish: boolean) => {
    ...
    try {
      if (publish) {
        ...
        const thumbOk = await generateThumbnail(savedId, { ...editing, ...rest })
        if (!thumbOk) {
          toast.error('Thumbnail failed — saved as draft instead')
          setPublishing(false)
          setEditing(null)
          load()
          return
    ...
    return (
      <div>
        ...
        <div className="mm-admin-grid">
          ...
          {/* Cover auto-generated by AI on publish */}
        </div>

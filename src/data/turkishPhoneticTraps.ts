...
export const PHONETIC_TRAPS: PhoneticTrap[] = [
  // ── 1. TH voiceless /θ/ ─────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      },
      {
        id: 'th-v-mc2',
        type: 'multiple_choice',
        prompt: 'You keep fish in this — it is NOT "thank":',
        promptTr: 'Balıkları bunda tutarsın — "thank" DEĞİL:',
        targetWord: 'tank',
  ...
  // ── 3. W vs V ────────────────────────────────────────────────────────────
  {
    ...
    targetSoundIPA: '/w/',
    turkishEquivalent: 'v',
    commonError: 'Turkish has /v/ but no /w/. "west" is said as "vest", "we" as "ve"',
    commonErrorTr: 'Türkçede /v/ var ama /w/ yok. "west" kelimesi "vest" olarak söylenir',
    ...
    color: '#2563EB',
    minimalPairs: [
      { english: 'west', errorVersion: 'vest', meaning: 'the direction where the sun sets', meaningTr: 'güneşin battığı yön (batı)' },
      { english: 'wail', errorVersion: 'veil', meaning: 'to cry loudly', meaningTr: 'yüksek sesle ağlamak' },

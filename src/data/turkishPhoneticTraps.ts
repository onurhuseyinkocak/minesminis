...
export const PHONETIC_TRAPS: PhoneticTrap[] = [
  ...
  // ── 7. English /r/ ───────────────────────────────────────────────────────
  {
    ...
    color: '#0891B2',
    minimalPairs: [
      { english: 'rice', errorVersion: 'rrice (trilled)', meaning: 'a grain food', meaningTr: 'tahıl yiyeceği (pirinç)' },
      { english: 'rain', errorVersion: 'rrain (trilled)', meaning: 'water falling from the sky', meaningTr: 'gökten düşen su (yağmur)' },
      { english: 'run', errorVersion: 'rrun (trilled)', meaning: 'to move fast on foot', meaningTr: 'ayakla hızlı hareket etmek (koşmak)' },
      { english: 'road', errorVersion: 'rroad (trilled)', meaning: 'a path for vehicles', meaningTr: 'araçlar için yol' },
      { english: 'read', errorVersion: 'rread (trilled)', meaning: 'to look at text', meaningTr: 'metne bakmak (okumak)' },
    ],
    exercises: [
      {
        id: 'er-mc1',

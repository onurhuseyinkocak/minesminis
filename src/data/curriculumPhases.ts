...
const phase1Units: LearningUnit[] = [
  // Unit 1: s, a, t
  {
    ...
    titleTr: 'Yılan, Karınca ve Tenis',
    ...
    activities: [
      { type: 'sound-intro', title: 'Meet the Snake', titleTr: 'Yılanla Tanış', description: 'Learn the /s/ sound with the slithering snake action.', xp: 10, duration: 3 },
      { type: 'sound-intro', title: 'Ants on Arms', titleTr: 'Kollardaki Karıncalar', description: 'Learn the /a/ sound with the tickly ants action.', xp: 10, duration: 3 },
      { type: 'sound-intro', title: 'Tennis Time', titleTr: 'Tenis Zamanı', description: 'Learn the /t/ sound by watching tennis.', xp: 10, duration: 3 },
      ...
      { type: 'blending', title: 'First Blends', titleTr: 'İlk Karıştırmalar', description: 'Blend s-a-t to make "sat". Your first word!', xp: 20, duration: 5 },
      { type: 'word-match', title: 'Match the Picture', titleTr: 'Resmi Eşle', description: 'Match pictures to words: sat, at, a.', xp: 15, duration: 3 },
    ],
  },
  // Unit 2: i, p, n
  {
    ...
    activities: [
      { type: 'sound-intro', title: 'Mouse Squeaks', titleTr: 'Fare Ciyaklıyor', description: 'Learn the /i/ sound like a little mouse.', xp: 10, duration: 3 },
      { type: 'sound-intro', title: 'Birthday Puffs', titleTr: 'Doğum Günü Üflemeleri', description: 'Learn the /p/ sound by blowing candles.', xp: 10, duration: 3 },
      { type: 'sound-intro', title: 'Airplane Flies', titleTr: 'Uçak Uçuyor', description: 'Learn the /n/ sound like an airplane.', xp: 10, duration: 3 },
      { type: 'song', title: 'Sound Safari Song', titleTr: 'Ses Safarisi Şarkısı', description: 'Sing the Group 1 song and learn all 6 sounds!', xp: 25, duration: 5 },
      ...
      { type: 'blending', title: 'Blend It Up', titleTr: 'Karıştır', description: 'Blend new words: pin, nap, tin, nip, sip, pan.', xp: 20, duration: 5 },
      { type: 'segmenting', title: 'Break It Apart', titleTr: 'Parçalara Ayır', description: 'Hear a word and break it into sounds: p-i-n.', xp: 20, duration: 5 },
      { type: 'reading', title: 'Read & Tap', titleTr: 'Oku ve Tıklat', description: 'Read simple words by tapping each sound.', xp: 25, duration: 5 },
      { type: 'tpr', title: 'Act It Out', titleTr: 'Canlandır', description: 'Follow commands using Group 1 words: Sit! Nap! Sip!', xp: 15, duration: 4 },
    ],
  },
  // Unit 3: c/k, e, h
  {
    ...
    activities: [
      ...
      { type: 'sound-intro', title: 'Egg Crack', titleTr: 'Yumurta Kırma', description: 'Learn the /e/ sound by cracking eggs.', xp: 10, duration: 3 },
      { type: 'sound-intro', title: 'Happy Dog Pants', titleTr: 'Mutlu Köpek Soluyor', description: 'Learn the /h/ sound by panting.', xp: 10, duration: 3 },
      { type: 'pronunciation', title: 'k vs c', titleTr: 'k ve c Farkı', description: 'Both c and k make the same sound in English. Practice!', xp: 15, duration: 4 },
      { type: 'blending', title: 'Pet Words', titleTr: 'Evcil Hayvan Kelimeleri', description: 'Blend: cat, hat, hen, pet, kit, hut.', xp: 20, duration: 5 },
      { type: 'word-match', title: 'Food Match', titleTr: 'Yiyecek Eşleştirme', description: 'Match food pictures to words.', xp: 15, duration: 3 },
      { type: 'reading', title: 'Sentence Time', titleTr: 'Cümle Zamanı', description: 'Read your first short sentences!', xp: 25, duration: 5 },
    ],
  },
  // Unit 4: r, m, d
  {
    ...
    activities: [
      { type: 'sound-intro', title: 'Lion Roars', titleTr: 'Aslan Kükreyor', description: 'Learn the /r/ sound. Remember: English r is different from Turkish!', xp: 10, duration: 3 },
      ...
      { type: 'sound-intro', title: 'Beat the Drum', titleTr: 'Davulu Çal', description: 'Learn the /d/ sound by drumming.', xp: 10, duration: 3 },
      { type: 'pronunciation', title: 'English R Practice', titleTr: 'İngilizce R Çalışması', description: 'Special lesson on the English r sound for Turkish speakers.', xp: 20, duration: 5 },
  ...
  // Unit 5: g, o, u
  {
    ...
    titleTr: 'Yudumla, Ahtapot ve Şemsiye',
    ...
    activities: [
      ...
      { type: 'sound-intro', title: 'Surprised O', titleTr: 'Şaşırmış O', description: 'Learn the /o/ sound with a surprised face.', xp: 10, duration: 3 },
      { type: 'sound-intro', title: 'Umbrella Up', titleTr: 'Şemsiye Aç', description: 'Learn the /u/ sound. Different from Turkish u!', xp: 10, duration: 3 },
      { type: 'pronunciation', title: 'Turkish Traps', titleTr: 'Türkçe Tuzakları', description: 'English o and u are different from Turkish. Practice the difference.', xp: 20, duration: 5 },
      { type: 'blending', title: 'Nature Words', titleTr: 'Doğa Kelimeleri', description: 'Blend: dog, hot, sun, bug, mud, gust, fog, hug.', xp: 20, duration: 5 },
      ...
      { type: 'spelling', title: 'Spell It Out', titleTr: 'Harflerle Yaz', description: 'Hear the word, pick the letters: g-o-t, b-u-s, h-o-t.', xp: 20, duration: 5 },
    ],
  },
  // Unit 6: l, f, b + Group 1-3 Review
  {
    ...
    activities: [
      ...
      { type: 'sound-intro', title: 'Ball Bounce', titleTr: 'Top Zıpla', description: 'Learn the /b/ sound by bouncing.', xp: 10, duration: 3 },
      ...
      { type: 'spelling', title: 'Big Spell Review', titleTr: 'Büyük Heceleme Tekrarı', description: 'Spell 10 words using all 18 sounds from Groups 1-3.', xp: 25, duration: 5 },
    ],
  },
];
...
const phase2Units: LearningUnit[] = [
  // Unit 1: ai, j, oa
  {
    ...
    titleTr: 'Yağmur, Jöle ve Tekneler',
    ...
    activities: [
      { type: 'sound-intro', title: 'Rainy Day', titleTr: 'Yağmurlu Gün', description: 'Learn the /ai/ sound like rain on your hand.', xp: 15, duration: 4 },
      { type: 'sound-intro', title: 'Wobbly Jelly', titleTr: 'Titreşen Jöle', description: 'Learn the /j/ sound like wobbling jelly.', xp: 15, duration: 4 },
      ...
      { type: 'pronunciation', title: 'Long vs Short', titleTr: 'Uzun vs Kısa', description: 'Hear the difference: cat vs coat, hat vs hate, pan vs pain.', xp: 20, duration: 5 },
      ...
      { type: 'tpr', title: 'Weather Dance', titleTr: 'Hava Durumu Dansı', description: 'Act out weather: rain, sail, jog, splash!', xp: 15, duration: 4 },
    ],
  },
  // Unit 2: ie, ee, or
  {
    ...
    activities: [
      { type: 'sound-intro', title: 'Fly the Kite', titleTr: 'Uçurtma Uçur', description: 'Learn the /ie/ sound like a kite in the sky.', xp: 15, duration: 4 },
      { type: 'sound-intro', title: 'Buzzy Bee', titleTr: 'Vızıldayan Arı', description: 'Learn the /ee/ sound like a happy bee.', xp: 15, duration: 4 },
      { type: 'sound-intro', title: 'Row to Shore', titleTr: 'Kıyıya Kürek Çek', description: 'Learn the /or/ sound while rowing.', xp: 15, duration: 4 },
      { type: 'blending', title: 'Garden Words', titleTr: 'Bahçe Kelimeleri', description: 'Blend: tree, bee, seed, tie, pie, corn, fork.', xp: 20, duration: 5 },
      ...
      { type: 'reading', title: 'Garden Story', titleTr: 'Bahçe Hikayesi', description: 'Read about bees and trees in a garden.', xp: 25, duration: 5 },
  ...
  // Unit 3: z, w, ng
  {
    ...
    titleTr: 'Vızıltı, Rüzgâr ve Yüzük',
    ...
    activities: [
      ...
      { type: 'sound-intro', title: 'Windy W', titleTr: 'Rüzgârlı W', description: 'Learn the /w/ sound. New for Turkish speakers!', xp: 15, duration: 4 },
      { type: 'sound-intro', title: 'Strong Ring', titleTr: 'Güçlü Zilsesi', description: 'Learn the /ng/ sound like ringing a bell.', xp: 15, duration: 4 },
      { type: 'pronunciation', title: 'W is Not V!', titleTr: 'W, V Değil!', description: 'Special practice: English w is different from v. Round your lips!', xp: 20, duration: 5 },
      { type: 'blending', title: 'Music Words', titleTr: 'Müzik Kelimeleri', description: 'Blend: ring, sing, song, wing, zing, buzz, win, wag.', xp: 20, duration: 5 },
      { type: 'segmenting', title: 'ng Ending', titleTr: 'ng Sonu', description: 'Identify the ng sound at the end of words.', xp: 20, duration: 5 },
      { type: 'tpr', title: 'Music Moves', titleTr: 'Müzik Hareketleri', description: 'Sing, ring, wave, and zig-zag!', xp: 15, duration: 4 },
      { type: 'story', title: 'The Singing King', titleTr: 'Şarkı Söyleyen Kral', description: 'Read about a king who loves to sing.', xp: 25, duration: 5 },
    ],
  },
  // Unit 4: v, oo(short), oo(long)
  {
    ...
    activities: [
      { type: 'sound-intro', title: 'Vroom Van', titleTr: 'Viin Minibüs', description: 'Learn the /v/ sound driving a van.', xp: 15, duration: 4 },
      { type: 'sound-intro', title: 'Good Book', titleTr: 'İyi Kitap', description: 'Learn the short /oo/ sound as in book.', xp: 15, duration: 4 },
      ...
      { type: 'listening', title: 'oo or oo?', titleTr: 'Kısa oo mu Uzun oo mu?', description: 'Tricky! Is it short oo (book) or long oo (moon)?', xp: 20, duration: 5 },
      ...
      { type: 'word-match', title: 'Day vs Night', titleTr: 'Gündüz vs Gece', description: 'Sort words into day and night categories.', xp: 15, duration: 4 },
      { type: 'reading', title: 'Moonlit Story', titleTr: 'Ayışığı Hikayesi', description: 'Read about adventures under the moon.', xp: 25, duration: 5 },
    ],
  },
  // Unit 5: Group 3-5 Blending Mastery
  {
    ...
    titleTr: 'Kelime İnşaatı Atölyesi',
    ...
    activities: [
      ...
      { type: 'reading', title: 'Builder Bob', titleTr: 'İnşaatçı Bob', description: 'Read the Builder Bob decodable story.', xp: 30, duration: 6 },
      { type: 'pronunciation', title: 'Sound Review', titleTr: 'Ses Tekrarı', description: 'Review all 30 sounds learned so far.', xp: 20, duration: 5 },
    ],
  },
  // Unit 6: Group 3-5 Review & Assessment
  {
    ...
    titleTr: 'Kelime İnşaatı Yarışması',
    ...
    activities: [
      ...
      { type: 'blending', title: 'Speed Blend', titleTr: 'Hızlı Karıştırma', description: 'Blend words as fast as you can! Beat the clock!', xp: 25, duration: 5 },
      { type: 'segmenting', title: 'Sound Splitter', titleTr: 'Ses Parçalayıcı', description: 'Break long words apart quickly.', xp: 25, duration: 5 },
      ...
      { type: 'spelling', title: 'Spell Quest', titleTr: 'Heceleme Görevi', description: 'Spell 15 challenge words from Groups 3-5.', xp: 30, duration: 6 },
      { type: 'story', title: 'Create a Story', titleTr: 'Hikaye Oluştur', description: 'Choose words to make your own mini story!', xp: 30, duration: 5 },
    ],
  },
];
...
const phase3Units: LearningUnit[] = [
  // Unit 1: y, x, ch, sh
  {
    ...
    activities: [
      ...
      { type: 'sound-intro', title: 'X Marks the Spot', titleTr: 'X Yeri İşaretle', description: 'Learn /ks/ sound by crossing arms.', xp: 15, duration: 4 },
      { type: 'sound-intro', title: 'Choo-Choo Train', titleTr: 'Çuf-Çuf Tren', description: 'Learn /ch/ sound. Same as Turkish c!', xp: 15, duration: 4 },
      { type: 'sound-intro', title: 'Quiet Baby', titleTr: 'Sessiz Bebek', description: 'Learn /sh/ sound. Same as Turkish ş!', xp: 15, duration: 4 },
  ...
  // Unit 2: th(voiced), th(unvoiced)
  {
    ...
    activities: [
      { type: 'sound-intro', title: 'Buzzy Tongue', titleTr: 'Vızıltılı Dil', description: 'Learn voiced /th/. Tongue between teeth, voice ON!', xp: 20, duration: 5 },
      ...
      { type: 'pronunciation', title: 'th Practice Zone', titleTr: 'th Pratik Alanı', description: 'Special practice for Turkish speakers. This sound does not exist in Turkish!', xp: 25, duration: 6 },
      ...
      { type: 'blending', title: 'Thinking Words', titleTr: 'Düşünce Kelimeleri', description: 'Blend: the, this, that, them, thin, thick, think, math.', xp: 20, duration: 5 },
      { type: 'reading', title: 'Think About It', titleTr: 'Bir Düşün', description: 'Read sentences with th words.', xp: 25, duration: 5 },
    ],
  },
  // Unit 3: qu, ou, oi
  {
    ...
    titleTr: 'Kraliçe, Bulut ve Bozuk Para',
    ...
    activities: [
      { type: 'sound-intro', title: 'Quacking Duck', titleTr: 'Vaklayan Ördek', description: 'Learn /qu/ sound like a duck quacking.', xp: 15, duration: 4 },
      { type: 'sound-intro', title: 'Ouch Cloud', titleTr: 'Ayyy Bulutu', description: 'Learn /ou/ sound like saying ouch.', xp: 15, duration: 4 },
      { type: 'sound-intro', title: 'Pirate Coin', titleTr: 'Korsan Parası', description: 'Learn /oi/ sound like a pirate finding coins.', xp: 15, duration: 4 },
      ...
      { type: 'reading', title: 'Queen\'s Quest', titleTr: 'Kraliçenin Görevi', description: 'Read the queen\'s treasure quest story.', xp: 30, duration: 6 },
      { type: 'story', title: 'Write the Ending', titleTr: 'Sonu Yaz', description: 'Choose how the queen\'s quest ends!', xp: 25, duration: 5 },
      { type: 'spelling', title: 'Quest Spelling', titleTr: 'Görev Hecelemesi', description: 'Spell qu, ou, and oi words correctly.', xp: 20, duration: 5 },
    ],
  },
  // Unit 4: ue, er, ar
  {
    ...
    activities: [
      ...
      { type: 'sound-intro', title: 'Mixer Stir', titleTr: 'Mikser Karıştırma', description: 'Learn /er/ sound like a mixer stirring.', xp: 15, duration: 4 },
      { type: 'sound-intro', title: 'Starlight', titleTr: 'Yıldız Işığı', description: 'Learn /ar/ sound looking at stars.', xp: 15, duration: 4 },
      { type: 'pronunciation', title: 'er Sound Practice', titleTr: 'er Ses Pratiği', description: 'The /er/ sound is very common and tricky for Turkish speakers.', xp: 20, duration: 5 },
      ...
      { type: 'reading', title: 'Star Journey', titleTr: 'Yıldız Yolculuğu', description: 'Read the complete star journey story.', xp: 30, duration: 6 },
      ...
      { type: 'story', title: 'My Star Story', titleTr: 'Benim Yıldız Hikayem', description: 'Create your own space adventure story!', xp: 30, duration: 5 },
    ],
  },
];
...
const phase4Units: LearningUnit[] = [
  // Unit 1: Fluency & Expression
  {
    ...
    activities: [
      ...
      { type: 'pronunciation', title: 'Expression Practice', titleTr: 'İfade Pratiği', description: 'Say the same sentence in different ways: question, exclamation, whisper.', xp: 20, duration: 5 },
      { type: 'listening', title: 'How Do They Feel?', titleTr: 'Nasıl Hissediyorlar?', description: 'Listen and identify the emotion from the voice.', xp: 20, duration: 5 },
  ...
  // Unit 2: Comprehension & Vocabulary
  {
    ...
    activities: [
      ...
      { type: 'listening', title: 'Story Questions', titleTr: 'Hikaye Soruları', description: 'Listen to a story and answer comprehension questions.', xp: 20, duration: 5 },
      { type: 'word-match', title: 'Character Match', titleTr: 'Karakter Eşleştirme', description: 'Match characters to their actions in the story.', xp: 15, duration: 4 },
      { type: 'story', title: 'Predict & Create', titleTr: 'Tahmin Et ve Oluştur', description: 'What happens next? Create your own ending.', xp: 30, duration: 6 },
  ...
  // Unit 3: Writing & Composition
  {
    ...
    activities: [
      { type: 'spelling', title: 'Story Starters', titleTr: 'Hikaye Başlangıçları', description: 'Learn and spell common story starter phrases.', xp: 20, duration: 5 },
      { type: 'reading', title: 'Read Model Stories', titleTr: 'Örnek Hikayeleri Oku', description: 'Read short stories as models for your own writing.', xp: 25, duration: 5 },
      { type: 'word-match', title: 'Story Sequencing', titleTr: 'Hikaye Sıralama', description: 'Put story events in the correct order.', xp: 20, duration: 5 },
      ...
      { type: 'listening', title: 'Story Sharing', titleTr: 'Hikaye Paylaşımı', description: 'Listen to other stories and give feedback.', xp: 15, duration: 4 },
    ],
  },
  // Unit 4: All Sounds Mastery & Graduation
  {
    ...
    activities: [
      { type: 'listening', title: 'Sound Master Quiz', titleTr: 'Ses Ustası Sınavı', description: 'Identify all 42 sounds in a grand quiz!', xp: 40, duration: 8 },
      { type: 'blending', title: 'Champion Blend', titleTr: 'Şampiyon Karıştırması', description: 'Blend the trickiest words from all 7 groups.', xp: 30, duration: 6 },
      { type: 'spelling', title: 'Champion Spelling', titleTr: 'Şampiyon Hecelemesi', description: 'Spell 20 challenge words from across all groups.', xp: 35, duration: 7 },
      { type: 'reading', title: 'Champion Reading', titleTr: 'Şampiyon Okuması', description: 'Read a long passage fluently with expression.', xp: 35, duration: 7 },
      { type: 'story', title: 'My Best Story', titleTr: 'En İyi Hikayem', description: 'Create and read your best story using all sounds.', xp: 40, duration: 8 },
      { type: 'tpr', title: 'Celebration Dance', titleTr: 'Kutlama Dansı', description: 'Celebrate your achievement with a final TPR session!', xp: 20, duration: 4 },
    ],
  },
];
...
export const PHASES: LearningPhase[] = [
  {
    ...
    descriptionTr: 'Oyun, hareketler ve hikayeler aracılığıyla ilk 18 İngilizce sesi keşfet. Sesleri birleştirerek ilk kelimelerini oluştur.',
    icon: '\u{1F442}',
    color: '#FF6B6B',
    phonicsGroups: [1, 2, 3],
  ...
  },
  {
    ...
    number: 2,
    name: 'Word Builders',
    nameTr: 'Kelime İnşaatçıları',
    ageRange: '4-6',
    description: 'Master long vowels, digraphs, and tricky sounds. Build longer words and read simple stories independently.',
    descriptionTr: 'Uzun seslileri, çifte harfleri ve zor sesleri ustalaş. Daha uzun kelimeler oluştur ve basit hikayeleri bağımsız oku.',
    icon: '\u{1F3D7}\u{FE0F}',
    color: '#4ECDC4',
    phonicsGroups: [3, 4, 5],
  ...
  },
  {
    ...
    number: 3,
    name: 'Story Makers',
    nameTr: 'Hikaye Yapıcılar',
    ageRange: '5-7',
    description: 'Learn all 42 sounds including the trickiest ones for Turkish speakers. Read and create your own stories!',
    descriptionTr: 'Türkçe konuşanlar için en zor sesler dahil 42 sesin tamamını öğren. Kendi hikayelerini oku ve oluştur!',
    icon: '\u{1F4DA}',
    color: '#45B7D1',
    phonicsGroups: [5, 6, 7],
  ...
  },
  {
    ...
    nameTr: 'Genç Kaşifler',
    ageRange: '6-8',
    description: 'Read with expression, understand stories deeply, and write your own tales. You are a phonics champion!',
    descriptionTr: 'İfadeyle oku, hikayeleri derinlemesine anla ve kendi hikayelerini yaz. Sen bir fonetik şampiyonusun!',
    icon: '\u{1F30D}',
    color: '#96CEB4',

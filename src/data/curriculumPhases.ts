...
const phase1Units: LearningUnit[] = [
  ...
  // Unit 2: i, p, n
  {
    ...
    activities: [
      ...
      { type: 'sound-intro', title: 'Airplane Flies', titleTr: 'Uçak Ucuyor', description: 'Learn the /n/ sound like an airplane.', xp: 10, duration: 3 },
  ...
  // Unit 3: c/k, e, h
  {
    ...
    activities: [
      ...
      { type: 'word-match', title: 'Food Match', titleTr: 'Yiyecek Eşlestirme', description: 'Match food pictures to words.', xp: 15, duration: 3 },
      { type: 'reading', title: 'Sentence Time', titleTr: 'Cumle Zamanı', description: 'Read your first short sentences!', xp: 25, duration: 5 },
    ],
  },
  // Unit 4: r, m, d
  {
...
const phase4Units: LearningUnit[] = [
  ...
  // Unit 2: Comprehension & Vocabulary
  {
    ...
    activities: [
      ...
      { type: 'word-match', title: 'Character Match', titleTr: 'Karakter Eşlestirme', description: 'Match characters to their actions in the story.', xp: 15, duration: 4 },
...
export const PHASES: LearningPhase[] = [
  ...
  },
  {
    ...
    descriptionTr: 'Uzun seslileri, çifte harfleri ve zor sesleri ustala. Daha uzun kelimeler oluştur ve basit hikayeleri bağımsız oku.',
    icon: '\u{1F3D7}\u{FE0F}',
    color: '#4ECDC4',
    phonicsGroups: [3, 4, 5],

...
const phonicsGroup2: KidsWord[] = [
    ...
    { word: "mat", level: "beginner", category: "Phonics", emoji: "🏋️", turkish: "paspas", phonicsGroup: 2 },
...
const phonicsGroup3: KidsWord[] = [
    ...
    { word: "bat", level: "beginner", category: "Animals", emoji: "🦇", turkish: "yarasa", phonicsGroup: 3, example: "baseball bat", exampleSentence: "Hit the ball with a bat.", exampleSentenceTr: "Topa sopayla vur." },
...
const phonicsGroup5: KidsWord[] = [
    ...
    { word: "wet", level: "beginner", category: "Phonics", emoji: "💧", turkish: "ıslak", phonicsGroup: 5, exampleSentence: "My hair is wet.", exampleSentenceTr: "Saçım ıslak." },
    ...
    { word: "van", level: "beginner", category: "Phonics", emoji: "🚐", turkish: "minibüs", phonicsGroup: 5, exampleSentence: "The van is big.", exampleSentenceTr: "Minibüs büyük." },
...
const foodWords: KidsWord[] = [
    ...
    { word: "nut", level: "beginner", category: "Food", emoji: "🥜", turkish: "fındık", phonicsGroup: 3 },
...
const bodyWords: KidsWord[] = [
    ...
    { word: "head", level: "beginner", category: "Body", emoji: "🧠", turkish: "baş", phonicsGroup: 4 },
...
const numbersWords: KidsWord[] = [
    ...
    { word: "eight", level: "intermediate", category: "Numbers", emoji: "8️⃣", turkish: "sekiz", phonicsGroup: 4 },

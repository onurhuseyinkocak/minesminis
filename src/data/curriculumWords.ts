...
const level5Routines: CurriculumWord[] = [
  ...
  { english: 'travel', turkish: 'seyahat etmek', emoji: '🚌', category: 'Routines', level: 5, partOfSpeech: 'verb', exampleEn: 'We travel by bus.', exampleTr: 'Otobüsle seyahat ederiz.', phonics: 'short-a', frequency: 52 },

...
export const grammarLessons: GrammarLesson[] = [
    ...
    exercises: [
      {
        ...
        options: ['This', 'That'],
        answer: 'This',
        explanation: 'Close to you → This',
        explanationTr: 'Yakında → This',
      },
      {
        type: 'multiChoice',
        ...
        options: ['This', 'That'],
        answer: 'That',
        explanation: 'Far from you → That',
        explanationTr: 'Uzakta → That',
      },
      {
        type: 'multiChoice',
        question: '___ is my hand. (you can see your hand right now)',
        questionTr: '___ benim elim. (eline bakıyorsun)',
        options: ['This', 'That'],
        answer: 'This',
        explanation: 'Your own hand is close → This',
        explanationTr: 'Kendi elin yakında → This',
      },
    ],
  },
  ...
  // ─── LEVEL 1: Am/Is/Are ─────────────────────────────────────────────────────
  {
    ...
    topicTr: 'Am / Is / Are',
    level: 1,
    turkishNote: 'Türkçede fark yok — hepsi "...dir/...yım". İngilizcede I=am, o(tekil)=is, onlar/biz=are',
    pattern: 'I + am | he/she/it + is | you/we/they + are',
    patternTr: 'I + am | o (tek) + is | sen/biz/onlar + are',
    examples: [
      { en: 'I am happy.', tr: 'Ben mutluyum.', highlight: 'am' },
      { en: 'The cat is small.', tr: 'Kedi küçük.', highlight: 'is' },
      { en: 'The cats are small.', tr: 'Kediler küçük.', highlight: 'are' },
      { en: 'She is my friend.', tr: 'O benim arkadaşım.', highlight: 'is' },
    ...
    exercises: [
      {
        ...
        questionTr: 'Ben bir öğrenciyim.',
        options: ['am', 'is', 'are'],
        answer: 'am',
        explanation: 'I → am (always!)',
        explanationTr: 'I → her zaman am',
      },
      {
        type: 'multiChoice',
        ...
        options: ['am', 'is', 'are'],
        answer: 'is',
        explanation: 'One dog (singular, not I) → is',
        explanationTr: 'Bir köpek (tekil, I değil) → is',
      },
      {
        type: 'multiChoice',
      ...
      },
      {
        ...
        options: ['am', 'is', 'are'],
        answer: 'is',
        explanation: 'She (singular, not I) → is',
        explanationTr: 'She (tekil, I değil) → is',
      },
    ],
  },
  ...
  // ─── LEVEL 2: My/Your/His/Her ───────────────────────────────────────────────
  {
    ...
    level: 2,
    turkishNote: 'Türkçede ek olarak gelir (-im, -in, -i). İngilizcede ayrı kelimeler! Dikkat: "his" erkek, "her" kız için!',
    ...
    examples: [
      ...
      { en: 'He loves his cat.', tr: 'O (erkek) kedisini seviyor.', highlight: 'his' },
      { en: 'She has her bag.', tr: 'O (kız) çantasını taşıyor.', highlight: 'her' },
      { en: 'We love our school.', tr: 'Biz okulumuzu seviyoruz.', highlight: 'our' },
      { en: 'They have their lunch.', tr: 'Onların öğle yemeği var.', highlight: 'their' },
    ],
    exercises: [
      {
        type: 'multiChoice',
        question: "Tom has ___ pencil. (Tom's pencil)",
        questionTr: "Tom'un kalemi var.",
        options: ['my', 'his', 'her'],
        answer: 'his',
      ...
      },
      {
        ...
        questionTr: "Mia kedisini seviyor.",
        options: ['my', 'his', 'her'],
        answer: 'her',
      ...
      {
        type: 'multiChoice',
        question: 'I have ___ book. (the book is mine)',
        questionTr: 'Benim kitabım var.',
        options: ['my', 'his', 'your'],
        answer: 'my',
        explanation: 'The speaker owns the book → my',
        explanationTr: 'Konuşan kişiye ait → my',
      },
      {
        type: 'multiChoice',
        question: 'We love ___ teacher.',
        questionTr: 'Biz öğretmenimizi seviyoruz.',
        options: ['my', 'our', 'their'],
        answer: 'our',
        explanation: '"We" → the teacher belongs to all of us → our',
        explanationTr: '"We" → hepimizin öğretmeni → our',
      },
    ],
  },
  ...
  // ─── LEVEL 2: Simple Present ────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        questionTr: 'Her gün ödevimi yaparım.',
  ...
  // ─── LEVEL 2: Can/Can't ─────────────────────────────────────────────────────
  {
    ...
    level: 2,
    turkishNote: '"Yapabilmek" = can + fiil (düz hali). "can runs" değil "can run"! Can sonrası -s eklenmez.',
    pattern: 'can + verb (base form) | cannot / can\'t + verb',
    patternTr: 'can + fiil (yalın hali) | can\'t + fiil',
    examples: [
    ...
    exercises: [
      ...
      },
      {
        ...
        questionTr: 'Kuşlar uçabilir.',
        options: ['can', "can't", 'cans'],
        answer: 'can',
        explanation: 'Birds have wings and fly → can',
        explanationTr: 'Kuşların kanatları var, uçabilirler → can',
      },
      {
        type: 'multiChoice',
        question: 'Fish ___ climb trees.',
        questionTr: 'Balıklar ağaca çıkamaz.',
        options: ['can', "can't", 'cans'],
        answer: "can't",
        explanation: 'Fish live in water — they cannot climb trees',
        explanationTr: 'Balıklar suda yaşar — ağaca çıkamazlar',
      },
      {
        type: 'multiChoice',
        question: 'I can ___ English!',
        questionTr: 'Ben İngilizce konuşabilirim!',
        options: ['speaks', 'speak', 'speaking'],
        answer: 'speak',
        explanation: 'After "can" → base form, no -s or -ing',
        explanationTr: '"can" sonrası → yalın hal, -s veya -ing eklenmez',
      },
    ],
  },
  ...
  // ─── LEVEL 2: Adjective Before Noun ─────────────────────────────────────
  {
    ...
    exercises: [
      {
        type: 'multiChoice',
        question: 'She has a ___ cat. (yellow)',
        questionTr: 'Onun sarı bir kedisi var.',
        options: ['yellow', 'yellowy', 'yellows'],
        answer: 'yellow',
        explanation: 'Adjective comes before the noun: a yellow cat',
        explanationTr: 'Sıfat isimden önce gelir: a yellow cat',
      },
      {
        type: 'multiChoice',
        question: 'I see ___.',
  ...
  // ─── LEVEL 3: Superlatives ───────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      {
        type: 'multiChoice',
        question: 'This is ___ flower in the garden.',
        questionTr: 'Bu bahçedeki en güzel çiçek.',

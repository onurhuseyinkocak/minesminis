...
const group1Sounds: PhonicsSound[] = [
  {
    ...
    actionTr: 'Elini yilan gibi kivir ve sssss de',
    story: 'The snake slithers through the sunny grass, making a ssssss sound.',
    storyTr: 'Yilan gunesli cimlerin arasinda surunuyor ve ssssss sesi cikartiyor.',
  ...
  },
  {
    ...
    actionTr: 'Parmaklarini kolunda karincalar gibi gezdirip a-a-a de',
    story: 'Oh no! Ants are crawling up your arm! A, a, a!',
    storyTr: 'Eyvah! Karincalar koluna tirmaniyorlar! A, a, a!',
  ...
  },
  {
    ...
    actionTr: 'Basini tenis izler gibi saga sola cevir ve t, t, t de',
  ...
  },
  {
    ...
    actionTr: 'Fare gibi davran, biyiklarini kipirdat ve i-i-i de',
    story: 'A tiny mouse squeaks i-i-i as it nibbles cheese.',
    storyTr: 'Minik bir fare peynir kemirirken i-i-i diye ciyakliyor.',
  ...
  },
  {
    ...
    actionTr: 'Dogum gunu mumlarini ufler gibi yap: p, p, p',
    story: 'Pop! Pop! Pop! goes the popcorn in the pan!',
    storyTr: 'Pat! Pat! Pat! diye patlak misir tavada patliyor!',
  ...
  },
  {
    ...
    actionTr: 'Kollarini ucak gibi ac ve nnnnnn de',
    story: 'The airplane flies through the sky: nnnnnn!',
    storyTr: 'Ucak gokyuzunde ucuyor: nnnnnn!',
...
const group2Sounds: PhonicsSound[] = [
  {
    ...
    actionTr: 'Hayali kastanyetler cal ve k, k, k de',
    story: 'The cat plays with a clicking castanet: c, c, c!',
    storyTr: 'Kedi tiklayan bir kastanyetle oynuyor: k, k, k!',
  ...
  },
  {
    ...
    actionTr: 'Bir yumurta kir ve eh, eh, eh de',
    story: 'Crack! The egg breaks open: eh, eh, eh!',
    storyTr: 'Ciirt! Yumurta kiriliyor: eh, eh, eh!',
  ...
  },
  {
    ...
    actionTr: 'Kosmaktan yorulmus bir kopek gibi soluya: h, h, h',
    story: 'The happy dog is panting after a big run: h, h, h!',
    storyTr: 'Mutlu kopek uzun bir kosunun ardindan soluyuyor: h, h, h!',
  ...
  },
  {
    ...
    ipa: '/\u0279/',
    group: 2,
    action: 'Pretend to be a roaring lion: rrrrrr',
    actionTr: 'Kukreyen bir aslan gibi davran: rrrrrr',
    story: 'The little lion cub learns to roar: rrrrrr!',
    storyTr: 'Kucuk aslan yavrusu kukremeyi ogreniyor: rrrrrr!',
    keywords: ['rat', 'ran', 'rip', 'rag', 'red', 'rug', 'run', 'rut'],
    mnemonicEmoji: '\u{1F981}',
    turkishNote: "Very different from Turkish 'r'! English 'r' does NOT roll. Curl your tongue back, don't touch the roof of your mouth.",
    order: 4,
  },
  {
    id: 'g2_m',
    ...
    actionTr: 'Karnini lezzetli yemek yerken ovsturur gibi yap: mmmmm',
    story: 'Mmmm, this muffin is so delicious! Mmmmm!',
    storyTr: 'Mmmm, bu muffin cok lezzetli! Mmmmm!',
  ...
  },
  {
    ...
    actionTr: 'Ellerinle davul cal: d, d, d',
    story: 'Bang the drum loudly: d, d, d!',
    storyTr: 'Davulu gucluce cal: d, d, d!',
...
const group3Sounds: PhonicsSound[] = [
  {
    ...
    actionTr: 'Bir bardaktan su ic gibi yap: g, g, g',
    story: 'Glug, glug! Drink a big glass of water: g, g, g!',
    storyTr: 'Glu glu! Buyuk bir bardak su ic: g, g, g!',
  ...
  },
  {
    ...
    actionTr: 'Sasirmis gibi agzinla O yap: o, o, o',
  ...
  },
  {
    ...
    actionTr: 'Bir semsiye ac ve kapat: u, u, u',
    story: "It's raining! Quick, open the umbrella: uh, uh, uh!",
    storyTr: 'Yagmur yagiyor! Cabuk, semsiyeyi ac: u, u, u!',
    keywords: ['up', 'us', 'cup', 'cut', 'but', 'bus', 'bug', 'fun'],
    mnemonicEmoji: '\u{2602}\u{FE0F}',
    turkishNote: "Very different from Turkish 'u'! English short 'u' sounds more like Turkish 'a'. Say 'a' with rounded lips slightly.",
    order: 3,
  },
  {
    id: 'g3_l',
    ...
    storyTr: 'Harika! Limonlu lolipopi yala: llllll!',
  ...
  },
  {
    ...
    actionTr: 'Bir lastikten hava bosaltiyor gibi yap: fffff',
    story: 'Oh no, the tire is flat! Hear the air escape: fffff!',
    storyTr: 'Eyvah, lastik patlamis! Havanin kacisini dinle: fffff!',
  ...
  },
  {
    ...
    actionTr: 'Bir sopayla topa vuruyormus gibi yap: b, b, b',
    story: 'Bounce the ball: b, b, b!',
    storyTr: 'Topu zipplat: b, b, b!',
...
const group4Sounds: PhonicsSound[] = [
  {
    ...
    actionTr: 'Yagmurda elini kulagina koy ve ay-ay-ay de',
    story: "Oh no, it's raining! Put your hand out: ai, ai, ai!",
    storyTr: 'Eyvah, yagmur yagiyor! Elini uzat: ay, ay, ay!',
  ...
  },
  {
    ...
    actionTr: 'Bir jole gibi titreyerek sallan: c, c, c',
    story: 'The jelly wobbles on the plate: j, j, j!',
    storyTr: 'Jole tabakta titriyor: c, c, c!',
  ...
  },
  {
    ...
    actionTr: 'Ayak parmagini carptin gibi yap: oh! oh! oh!',
    story: 'The goat goes on a boat: oa, oa, oa!',
    storyTr: 'Keci tekneye biniyor: oa, oa, oa!',
  ...
  },
  {
    ...
    storyTr: 'Ucurtma gokte yuksekten ucuyor: ay, ay, ay!',
  ...
  },
  {
    ...
    actionTr: 'Ellerini dizlerine koy ve esek gibi eee de',
    story: 'The donkey says eee-ooor, eee-ooor!',
    storyTr: 'Esek eee-ooor, eee-ooor diyor!',
  ...
  },
  {
    ...
    actionTr: 'Bir tekne kurek cek ve or, or, or de',
    story: 'Row, row the boat to the shore: or, or, or!',
    storyTr: 'Kurek cek, kurek cek kiyiya: or, or, or!',
...
const group5Sounds: PhonicsSound[] = [
  {
    ...
    actionTr: 'Kollarini vizildayan ari gibi cirp: zzzzz',
    story: 'The busy bee buzzes around the flowers: zzzzz!',
    storyTr: 'Mesgul ari ciceklerin etrafinda vizildaniyor: zzzzz!',
  ...
  },
  {
    ...
    actionTr: 'Yavascca mum ufle ve vuh, vuh, vuh de',
    story: 'Whoosh! The wind blows: wuh, wuh, wuh!',
    storyTr: 'Vuuuus! Ruzgar esiyor: vuh, vuh, vuh!',
  ...
  },
  {
    ...
    actionTr: 'Agirlik kaldirir gibi yap ve ng, ng, ng de',
    story: 'The strong man lifts: nnng, nnng! Ring the bell: ng!',
    storyTr: 'Guclu adam kaldiriyor: nnng, nnng! Zili cal: ng!',
  ...
  },
  {
    ...
    actionTr: 'Bir minibus sur ve titresen direksiyonu tut: vvvvv',
    story: 'Vroom vroom! The van drives fast: vvvvv!',
    storyTr: 'Viiin viiin! Minibus hizla gidiyor: vvvvv!',
  ...
  },
  {
    ...
    actionTr: 'Agir bir kutu it ve kitaptaki gibi kisa oo, oo de',
  ...
  },
  {
    ...
    actionTr: 'Aya isaret et ve kurt gibi uzun ooooo de',
...
const group6Sounds: PhonicsSound[] = [
  ...
  },
  {
    ...
    actionTr: 'Kollarini X gibi caprazla ve ks, ks, ks de',
    story: 'X marks the spot on the treasure map: ks, ks!',
    storyTr: 'X hazine haritasinda yeri isaretiyor: ks, ks!',
  ...
  },
  {
    ...
    actionTr: 'Cuf cuf tren gibi hareket et: c, c, c, c',
    story: 'The train goes choo-choo: ch, ch, ch!',
    storyTr: 'Tren cuf cuf gidiyor: c, c, c!',
  ...
  },
  {
    ...
    actionTr: 'Parmagini dudagina koy ve shhhh, sessiz ol de!',
  ...
  },
  {
    ...
    actionTr: 'Dilini biraz cikar ve mirilda: thhhh (viziltili)',
    story: 'This, that, the, them \u2014 feel your throat buzz: th, th!',
    storyTr: 'This, that, the, them \u2014 bogazinin titresimini hisset: th, th!',
  ...
  },
  {
    ...
    actionTr: 'Dilini biraz cikar ve hava ufle: thhh (sessiz)',
    story: 'Think of three thin things: th, th, th! (no buzzing)',
    storyTr: 'Uc ince sey dusun: th, th, th! (viziltisiz)',
...
const group7Sounds: PhonicsSound[] = [
  {
    ...
    actionTr: 'Ordek gibi vakla: kvu, kvu, kvu',
    story: 'The queen\u2019s duck says quack, quack: qu, qu!',
    storyTr: 'Kralicenin ordegi vakladi: kvu, kvu!',
  ...
  },
  {
    ...
    actionTr: 'Parmagini batirmis gibi yap: AV! av, av!',
    story: 'Ouch! The mouse ran out of the house: ou, ou!',
    storyTr: 'Ayyy! Fare evden kacti: av, av!',
  ...
  },
  {
    ...
    actionTr: 'Bir seyi isaret et ve korsan gibi oy! oy! de',
  ...
  },
  {
    ...
    actionTr: 'Pencereden manzarayi goster: yu, yu, yu',
    story: 'What a beautiful view! Look at the blue: ue, ue!',
    storyTr: 'Ne guzel manzara! Maviye bak: yu, yu!',
  ...
  },
  {
    ...
    actionTr: 'Mikser karistir ve errrr, errrr de',
    story: 'The mixer goes errrr as it stirs the butter: er, er!',
    storyTr: 'Mikser tereyagini karistirirken errrr diyor: er, er!',
  ...
  },
  {
    ...
    actionTr: 'Doktordaymis gibi agzini ac ve ahhh-r de',
    story: 'The pirate says: ar, ar, ar! Stars are far!',
    storyTr: 'Korsan diyor ki: ar, ar, ar! Yildizlar uzakta!',

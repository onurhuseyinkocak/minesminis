...
const stage2Units: LearningUnit[] = [
  // Unit 2.1: Group 1 — s, a, t, i, p, n
  {
    ...
    activities: [
      act('sound-intro', 'Ssss — The Snake Sound /s/', 'Ssss — Yılan Sesi /s/', 'Snake slithers: ssssss! Tongue behind top teeth, push air. Turkish /s/ = same. Meet 5 s-words: sat, sip, sin, sap, set.', 25, 5),
      ...
      act('segmenting', 'Spell It Out!', 'Harf Harf Söyle!', 'SpellingBee: Say the sounds for: sat, pit, nip, tan, sin, tip. Segment then write.', 25, 5),
  ...
  // Unit 2.2: Group 1 Review — Building First Words
  {
    ...
    decodableText: 'Nat sat. A tan ant sat on a tin. Tip it! Pin it! Nap, Nat, nap. Tan sat in a pit. A sin? Nip it, Nat! Sit, sit, sit!',
    activities: [
  ...
  // Unit 2.3: Group 2 — c/k, e, h + Turkish c vs k trap
  {
    ...
    activities: [
      ...
      act('sound-intro', "Happy Dog Pants — /h/", "Mutlu Köpek Pantlar — /h/", 'Dog panting: h, h, h! Just a breath out — very soft. hat, hit, him, his, hen, hut, hug. No friction, just air.', 25, 5),
      act('blending', 'Build with 9 Sounds!', '9 Sesle İnşa Et!', 'PhonicsBlend — Now using all 9 sounds: s,a,t,i,p,n,c/k,e,h. Build: cat, hen, hit, cap, hat, net, pet, ten, set, hem. 10 words!', 30, 6),
      act('segmenting', 'Spell: cat, hat, hen, pet', 'Yaz: cat, hat, hen, pet', 'SpellingBee: cat, hat, hen, net, pet, set, hit, him, hid. Focus on c vs k choice.', 25, 5),
      act('story', 'Group 2 Story — Cat, Hat, Hen', 'Grup 2 Hikayesi — Kedi, Şapka, Tavuk', 'The cat sat in a hat. A hen can peck in a pen. He hid in a hut. Can the cat catch the hen? The kid hit the hat. Ha! Tap, tap. A hen sat. The hen set an egg in a net. Get it, Nat! THE END.', 30, 6),
    ],
  },
  // Unit 2.4: Group 2 continued — r, m, d + English /r/ approximant drill
  {
    ...
    activities: [
      ...
      act('blending', 'All 12 Sounds — Race Mode!', '12 Ses — Yarış Modu!', 'PhonicsBlend: Build 20 words in 4 minutes using all 12 sounds (s,a,t,i,p,n,c/k,e,h,r,m,d). Words: dad, red, hen, mat, pin, hit, dam, rug, men, kid, set, dim, ran, mud, rim, den, mad, nod, mid, rid.', 35, 7),
      act('segmenting', '12 Sounds Spelling Test', '12 Ses Yazım Testi', 'SpellingBee dictation: cat, red, hen, mat, pin, nap, hit, dam, rug, men, kid, set. Must score 80%+ for Group 2 Badge!', 35, 7),
  ...
  // Unit 2.7: Group 4 — Long Vowels ai, j, oa, ie, ee, or
  {
    ...
    activities: [
      act('listening', 'Rainy Day — /eɪ/ (ai)', 'Yağmurlu Gün — /eɪ/ (ai)', 'ai digraph = LONG vowel with TWO parts: /e/ then /ɪ/ — glide! Not Turkish "ey". ListeningChallenge: short vs long — cat vs rain, hat vs hail, pan vs pain. 10 rounds. PhonicsBlend: rain, tail, mail, sail, paid.', 25, 5),
...
const stage3Units: LearningUnit[] = [
  ...
  // Unit 3.2: w, v, qu, x — The /w/ vs /v/ Battle
  {
    ...
    activities: [
      act('pronunciation', 'Wind Blows — /w/ NOT /v/!', 'Rüzgar Eser — /w/ DEĞİL /v/!', 'CRITICAL for Turkish: "wine" ≠ "vine"! Turkish /v/ = teeth on lip friction. English /w/ = just lips rounded, NO teeth contact. Practice: wine/vine, west/vest, wet/vet, word/verb. PronunciationGame records and compares. Mandatory drill!', 30, 7),
      ...
      act('sound-intro', 'Fox in a Box — /ks/ (x)', 'Kutudaki Tilki — /ks/ (x)', 'x = /ks/ at end: fox, box, mix, fix, wax, tax, six, ax. Sometimes /gz/ in middle: exam, exact. PhonicsBlend with 8 x-words. WordMatch: fox→fox picture.', 20, 4),
  ...
  // Unit 3.3: Initial Consonant Blends — st, sp, sn, bl, cl, fl, gl
  {
    ...
    decodableText: 'A blue flag blew in the wind. Stop! A frog can spin. It flipped and fell flat. Clap! The snow snapped the branch. A glad frog in a glass. Spit it out! THE END.',
    activities: [
      ...
      act('blending', 'CCVC Blending Challenge', 'CCVC Birleştirme Meydan Okuma', 'PhonicsBlend: 20 CCVC words in 4 minutes: stop, spin, snap, blue, clap, flag, glad, step, spot, snag, black, clip, flip, glob, stem, spit, snip, flat, clan, glow. First time children read 4-sound words!', 35, 7),
      ...
      act('story', 'Initial Blends Story — The Frog Flag', 'Başlangıç Küme Hikayesi — Kurbağa Bayrağı', 'A blue flag blew in the wind. Stop! A frog can spin. It flipped and fell flat. Clap! The snow snapped the branch. A glad frog in a glass. Spit it out! THE END. (CCVC Master Badge!)', 30, 6),
    ],
  },
  // Unit 3.4: r-Blends — br, cr, dr, fr, gr, pr, tr
  {
    ...
    activities: [
      act('pronunciation', 'r-Blends — English /r/ in clusters!', 'r Kümeleri — Küme içinde İngilizce /r/!', 'The English /r/ approximant must be maintained even in blends! br-: bread, brim, brag. cr-: crab, cram, crest. dr-: drum, drip, drag. fr-: frog, from, fret. gr-: grass, grip, grin. pr-: press, price, prim. tr-: tree, trim, trip. PronunciationGame all 7!', 35, 7),
      act('blending', 'r-Blend Speed Round', 'r Kümesi Hız Turu', 'PhonicsBlend: 21 words (3 per blend): bread/brim/brag, crab/cram/crest, drum/drip/drag, frog/from/fret, grass/grip/grin, press/price/prim, tree/trim/trip. Fastest reader wins!', 35, 7),
...
const stage4Units: LearningUnit[] = [
  {
    ...
    activities: [
      act('sound-intro', 'igh = /aɪ/: night, light, right, fight, might, sight, bright', 'igh = /aɪ/: gece, ışık, sağ, dövüş, güç, görüş, parlak', 'igh digraph: THREE letters, ONE sound /aɪ/. night, light, right, fight, might, sight, bright, flight, tight, slight. PhonicsBlend 10 words.', 25, 5),
  ...
  },
  {
    ...
    activities: [
      ...
      act('sound-intro', 'gn = /n/ and mb = /m/: gnome, lamb, climb', 'gn = /n/ ve mb = /m/: cüce, kuzu, tırmanmak', 'gn: gnome, gnat, gnaw, gnu, sign, align. mb: lamb, climb, comb, bomb, thumb, limb, numb, dumb. Both silent! SpellingBee: 10 silent letter words.', 25, 5),

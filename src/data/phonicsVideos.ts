...
const group1Videos: PhonicsVideo[] = [
  {
    ...
    titleTr: 'Jolly Phonics s a t i p n Sarkisi',
    group: 1,
  ...
  },
  {
    ...
    titleTr: 's a t i p n Seslerini Ogren',
    group: 1,
    targetSounds: ['s', 'a', 't', 'i', 'p', 'n'],
    duration: '4:45',
    emoji: '\u{1F4DA}',
  ...
  },
  {
    ...
    titleTr: 'Alphablocks: SAT PIN TAN - Ilk Kelimeler',
    group: 1,
    targetSounds: ['s', 'a', 't', 'i', 'p', 'n'],
    duration: '5:02',
    emoji: '\u{1F4D6}',
  ...
  },
  {
    ...
    titleTr: 'Fonetik Tekrar: s a t i p n Birlestir',
    group: 1,
    targetSounds: ['s', 'a', 't', 'i', 'p', 'n'],
    duration: '3:30',
    emoji: '\u{1F504}',
...
const group2Videos: PhonicsVideo[] = [
  {
    ...
    titleTr: 'Jolly Phonics c k e h r m d Sarkisi',
    group: 2,
  ...
  },
  {
    ...
    titleTr: 'c k e h r m d Seslerini Ogren',
    group: 2,
    targetSounds: ['c', 'k', 'e', 'h', 'r', 'm', 'd'],
    duration: '5:15',
    emoji: '\u{1F4DA}',
  ...
  },
  {
    ...
    titleTr: 'Alphablocks: CAT HEN RED - Kelimeleri Birlestirme',
    group: 2,
    targetSounds: ['c', 'k', 'e', 'h', 'r', 'm', 'd'],
    duration: '4:50',
    emoji: '\u{1F4D6}',
...
const group3Videos: PhonicsVideo[] = [
  {
    ...
    titleTr: 'Jolly Phonics g o u l f b Sarkisi',
    group: 3,
  ...
  },
  {
    ...
    titleTr: 'g o u l f b Seslerini Ogren',
    group: 3,
    targetSounds: ['g', 'o', 'u', 'l', 'f', 'b'],
    duration: '4:30',
    emoji: '\u{1F4DA}',
  ...
  },
  {
    ...
    titleTr: 'Fonetik Tekrar: g o u l f b Birlestir',
    group: 3,
    targetSounds: ['g', 'o', 'u', 'l', 'f', 'b'],
    duration: '3:40',
    emoji: '\u{1F504}',
...
const group4Videos: PhonicsVideo[] = [
  {
    ...
    titleTr: 'Jolly Phonics ai j oa ie ee or Sarkisi',
    group: 4,
...
const group5Videos: PhonicsVideo[] = [
  {
    ...
    titleTr: 'Jolly Phonics z w ng v oo Sarkisi',
    group: 5,
  ...
  },
  {
    ...
    titleTr: 'z w ng v oo Seslerini Ogren',
    group: 5,
    targetSounds: ['z', 'w', 'ng', 'v', 'oo'],
    duration: '4:55',
    emoji: '\u{1F4DA}',
  ...
  },
  {
    ...
    titleTr: 'KidsTV123: z w ng v oo Tekrar Sarkisi',
    group: 5,
    targetSounds: ['z', 'w', 'ng', 'v', 'oo'],
    duration: '3:50',
    emoji: '\u{1F504}',
...
const group6Videos: PhonicsVideo[] = [
  {
    ...
    titleTr: 'Jolly Phonics y x ch sh th Sarkisi',
    group: 6,
  ...
  },
  {
    ...
    titleTr: 'Cifte Harfleri Ogren: ch sh th Sesleri',
    group: 6,
    targetSounds: ['y', 'x', 'ch', 'sh', 'th'],
    duration: '5:00',
    emoji: '\u{1F4DA}',
  ...
  },
  {
    ...
    titleTr: 'Alphablocks: SHIP CHAT THIN - Cifte Harf Hikayeleri',
    group: 6,
    targetSounds: ['y', 'x', 'ch', 'sh', 'th'],
    duration: '5:30',
    emoji: '\u{1F4D6}',
...
const group7Videos: PhonicsVideo[] = [
  {
    ...
    titleTr: 'Jolly Phonics qu ou oi ue er ar Sarkisi',
    group: 7,
  ...
  },
  {
    ...
    titleTr: 'qu ou oi ue er ar Seslerini Ogren',
    group: 7,
    targetSounds: ['qu', 'ou', 'oi', 'ue', 'er', 'ar'],
    duration: '5:40',
    emoji: '\u{1F4DA}',
  ...
  },
  {
    ...
    titleTr: 'British Council: Son Sesler Tekrari',
    group: 7,
    targetSounds: ['qu', 'ou', 'oi', 'ue', 'er', 'ar'],
    duration: '4:20',
    emoji: '\u{1F504}',

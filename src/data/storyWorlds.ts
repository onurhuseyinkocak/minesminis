...
export const WORLDS: Record<WorldId, WorldConfig> = {
  forest: {
    ...
    color: 'var(--world-forest)',
    gradient: 'linear-gradient(180deg, #87CEEB 0%, #4A8B3F 40%, var(--world-forest) 100%)',
  ...
  ocean: {
    ...
    color: 'var(--world-ocean)',
    gradient: 'linear-gradient(180deg, #87CEEB 0%, #2E86C1 30%, var(--world-ocean) 100%)',
    entryTrait: 'kindness',
    entryThreshold: 15,
  ...
  mountain: {
    ...
    color: 'var(--world-mountain)',
    gradient: 'linear-gradient(180deg, #2C3E50 0%, var(--world-mountain) 40%, #8E44AD 100%)',
    entryTrait: 'courage',
    entryThreshold: 15,
  ...
  space: {
    ...
    color: 'var(--world-space)',
    gradient: 'linear-gradient(180deg, var(--world-space) 0%, #1A1A4E 50%, #2D1B69 100%)',
    entryTrait: 'curiosity',
    entryThreshold: 25,
  ...
  desert: {
    ...
    color: 'var(--world-desert)',
    gradient: 'linear-gradient(180deg, #F39C12 0%, #D4AC0D 40%, var(--world-desert) 100%)',
    entryTrait: 'wisdom',
    entryThreshold: 15,
...
export const TRAIT_NAMES: Record<TraitId, { name: string; emoji: string; color: string }> = {
  courage: { name: 'Courage', emoji: '🦁', color: 'var(--error)' },
  wisdom: { name: 'Wisdom', emoji: '🦉', color: 'var(--info)' },
  kindness: { name: 'Kindness', emoji: '💚', color: 'var(--success)' },
  curiosity: { name: 'Curiosity', emoji: '🔭', color: 'var(--accent-purple)' },
};

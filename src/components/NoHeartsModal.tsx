...
// ── Broken heart SVG — genuine crack down the centre ─────────────────────────
...
const BrokenHeartSVG = () => (
  <svg
    ...
    aria-hidden="true"
  >
    {/* Heart fill — split into left and right halves */}
    <path
      d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09L12 5.25V21.35z"
      fill="currentColor"
      opacity="0.9"
    />
    <path
      d="M12 21.35l1.45-1.32C18.6 15.36 22 12.28 22 8.5 22 5.42 19.58 3 16.5 3c-1.74 0-3.41.81-4.5 2.09L12 5.25V21.35z"
      fill="currentColor"
      opacity="0.75"
    />
    {/* Crack / lightning bolt down the middle */}
    <polyline
      points="12,5 10.5,10 13,12.5 11,18"
      fill="none"
      stroke="var(--bg-card)"
      strokeWidth="1.5"
      strokeLinecap="round"

...
describe('Component Smoke Tests', () => {
  ...
  it('FloatingThemeToggle - renders toggle button', async () => {
    const { default: FloatingThemeToggle } = await import('../../components/FloatingThemeToggle');
  ...
  it('PetPlayground - renders without crash', async () => {
    const { default: PetPlayground } = await import('../../components/PetPlayground');
    const { container } = wrap(<PetPlayground />);
    // Component renders (may be empty if no user/pet, but should not throw)

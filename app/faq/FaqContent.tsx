...
const items: FaqItem[] = [
  ...
  { cat: 'guvenlik', q: 'Reklamlar çocuğum için güvenli mi?', a: 'Şu anda site reklam göstermiyor. Onay aşamasında AdSense kapalı. Onaydan sonra aktif edilecek reklamlar: (1) yalnızca bağlamsal, (2) yaşa uygun/çocuk içerik etiketiyle filtrelenmiş, (3) kişiselleştirilmiş hedefleme yapmaz.' },

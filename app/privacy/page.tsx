...
export const metadata: Metadata = {
  title: 'Gizlilik Politikası — COPPA & KVKK Uyumlu',
  description:
    'minesminis çocuk gizliliğini birinci öncelik kabul eder. COPPA ve KVKK uyumlu veri politikası, çerez kullanımı, üçüncü taraf hizmetler ve aile hakları hakkında ayrıntılı bilgi.',
...
const privacyBreadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Gizlilik Politikası', item: 'https://minesminis.com/privacy' },
  ],
}
...
export default function PrivacyPage() {
  return (
    <div style={{ maxWidth: 760, margin: '0 auto' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(privacyBreadcrumb) }} />
      ...
      <article style={{ background: 'white', borderRadius: 28, padding: 28, border: '1px solid var(--line)', lineHeight: 1.8, fontSize: 15, color: 'var(--ink-2)' }}>
        ...
        <h2 style={h2Style}>1. Hangi Bilgileri Topluyoruz?</h2>
        <p>
        ...
        <h2 style={h2Style}>2. Çerezler (Cookies)</h2>
        <p>Çerez kullanımımız üç sınırlı kategoriyle sınırlıdır:</p>
        <ul>
        ...
        <h2 style={h2Style}>3. COPPA Uyumu (ABD)</h2>
        <p>ABD'deki çocuk gizliliği kanunu olan Children's Online Privacy Protection Act (COPPA), 13 yaş altı çocuklardan veri toplama konusunda katı kurallar koyar. minesminis aşağıdaki şekilde uyumludur:</p>
        <ul>
        ...
        <h2 style={h2Style}>4. KVKK Uyumu (Türkiye)</h2>
        <p>6698 Sayılı Kişisel Verilerin Korunması Kanunu (KVKK) açısından minesminis'in veri sorumlusu sıfatı vardır. KVKK uyumumuz şu temellere dayanır:</p>
        <ul>
        ...
        <h2 style={h2Style}>5. Üçüncü Taraf Hizmetler</h2>
        <p>Platformumuz aşağıdaki üçüncü taraf hizmetlerini kullanır. Her birinin kendi gizlilik politikası vardır:</p>
        <ul>
        ...
        <h2 style={h2Style}>6. Çocuğunuzla Birlikte Kullanım</h2>
        <p>Çocuk gizliliği teknik koruma kadar gözetim ile sağlanır. Önerilerimiz:</p>
        <ul>
        ...
        <h2 style={h2Style}>7. Veri Güvenliği</h2>
        <p>
          Toplanan sınırlı teknik veriler endüstri standardı korumalarla saklanır: HTTPS zorunlu (TLS 1.3), Strict-Transport-Security politikası, X-Frame-Options, Content-Security-Policy, hosting tarafında uçtan uca şifreli yedekleme. Bir veri ihlali durumunda KVKK gereği 72 saat içinde Kişisel Verileri Koruma Kurumu'na ve etkilenen kullanıcılara bildirim yapılır.
        </p>

        <h2 style={h2Style}>8. Aile / Veli Hakları</h2>
        <p>Veli veya yasal vasi olarak şu haklara sahipsiniz:</p>
        <ul>
        ...
        <p>Tüm talepler için: <a href="mailto:info@minesminis.com" style={{ color: 'var(--accent)' }}>info@minesminis.com</a>. Geri dönüş süremiz 7 iş günüdür.</p>

        <h2 style={h2Style}>9. Politika Güncellemeleri</h2>
        <p>
        ...
        <h2 style={h2Style}>10. İletişim</h2>
        <p>
          Bu gizlilik politikası hakkında sorularınız için: <a href="mailto:info@minesminis.com" style={{ color: 'var(--accent)' }}>info@minesminis.com</a>. Daha kapsamlı bilgi için <Link href="/contact" style={{ color: 'var(--accent)' }}>İletişim</Link> sayfamızı da inceleyebilirsiniz.
        </p>
      </article>
    </div>
  )
